...
public class Main {
	...
	private static boolean matchTree(BinaSortTree r1, BinaSortTree r2) {  
	    ...
	    return (matchTree(r1.lchild, r2.lchild) && matchTree(r1.rchild, r2.rchild));  
	}  

	private static void organizeData(StreamTokenizer st, int n, BinaSortTree[] biTree) throws Exception{
